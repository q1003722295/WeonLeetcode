...
class Solution(object):
    def intToRoman(self, num):
        ...
        :rtype: str
        """
        dicRom = {1:'I', 4:'IV', 5:'V', 9:'IX', 10:'X', 40:'XL', 50:'L',
                  90:'XC', 100:'C', 400:'CD', 500:'D', 900:'CM', 1000:'M'}

        arrRom = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1000]
        t = ''

        while num > 0:
            for i in range(len(arrRom)):
                if i+1 < len(arrRom) and (num >= arrRom[i] and num < arrRom[i+1]):
                    break
